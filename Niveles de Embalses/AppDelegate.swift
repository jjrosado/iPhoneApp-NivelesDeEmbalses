...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("aPCMGpMUhHQwTHzujzA9dIQpoqR3FyJ6adPM9bzI", clientKey: "etSKJqOloDdeC62yErIo3osuaIKmwKrONGSWYiHN")
    ...
    //For Notifications test only
    //func application(application: UIApplication!, didFailRegisterForRemoteNotificationsWithError error: NSError!){
    //
    //    print("Fail!")
    //}
